  ...
  return (
    <div className="flex flex-col h-screen items-center">
      ...
      <section className="w-[80%]">
        ...
        <div className="flex flex-row flex-wrap items-center justify-evenly w-full mt-20 gap-5">
        ...
        <div className="flex flex-col items-center justify-center mt-10">
          {isSelected ? <h1 className="font-bold">Anything else? You can select multiple</h1> : null}
